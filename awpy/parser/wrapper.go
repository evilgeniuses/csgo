...
// #include <Python.h>
// #include <stdbool.h>
// int PyArg_ParseTuple_parse_demo(PyObject* args, char** dem_path, int* parse_rate, bool* parse_frames, bool* parse_kill_frames, int64_t* trade_time, char** round_buy, bool* damages_rolled, char** demo_id, bool* json_indentation, char** outpath);
import "C"
...
func parse_demo(self *C.PyObject, args *C.PyObject) (ret *C.PyObject) {
	...
	*/
	...
	if C.PyArg_ParseTuple_parse_demo(
		args, &demPath, &parseRate, &parseFrames, &parseKillFrames, &tradeTime,
	...
	parseKillFramesGo := bool(parseKillFrames)
